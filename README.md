...
你可以使用 `make cluster` 命令一键启动 3 个节点的集群（后台运行）：
...
**终端 1 (启动节点 1):**
```bash
./raft-server --id 1 --peers "1=127.0.0.1:8001,2=127.0.0.1:8002,3=127.0.0.1:8003" --data raft-data
```

**终端 2 (启动节点 2):**
```bash
./raft-server --id 2 --peers "1=127.0.0.1:8001,2=127.0.0.1:8002,3=127.0.0.1:8003" --data raft-data
```

**终端 3 (启动节点 3):**
```bash
./raft-server --id 3 --peers "1=127.0.0.1:8001,2=127.0.0.1:8002,3=127.0.0.1:8003" --data raft-data
```
